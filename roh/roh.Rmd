...
roh <- roh  %>% filter(Quality > 25 & Number_of_markers >50) %>%
...
```{r echo=FALSE}
roh_cummulative <- roh 
ranges <- seq(1e+06,20e+06,1e+06)

roh_cummulative$Range <- NA
roh_cummulative$Range <- ifelse(roh_cummulative$Length < 2e+06, 1,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 2e+06 &
                                  roh_cummulative$Length < 3e+06, 2,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length < 4e+06 & 
                                  roh_cummulative$Length > 3e+06, 3,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length < 5e+06 &
                                  roh_cummulative$Length > 4e+06, 4,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 5e+06 & 
                                  roh_cummulative$Length < 6e+06, 5,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length < 7e+06 &
                                  roh_cummulative$Length > 6e+06, 6,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length < 8e+06 &
                                  roh_cummulative$Length > 7e+06, 7,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length < 9e+06 &
                                  roh_cummulative$Length > 8e+06, 8,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length < 10e+06 & 
                                  roh_cummulative$Length > 9e+06, 9,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 10e+06 & 
                                  roh_cummulative$Length < 11e+06, 10,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 11e+06 & 
                                  roh_cummulative$Length < 12e+06, 11,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 12e+06 & 
                                  roh_cummulative$Length < 13e+06, 12,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 13e+06 & 
                                  roh_cummulative$Length < 14e+06, 13,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 14e+06 & 
                                  roh_cummulative$Length < 15e+06, 14,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 15e+06 & 
                                  roh_cummulative$Length < 16e+06, 15,roh_cummulative$Range)
roh_cummulative$Range <- ifelse(roh_cummulative$Length > 16e+06 ,16,roh_cummulative$Range)

roh$Range <- factor(roh$Range)
roh$Range <- ordered(roh$Range, levels = 1:16)


plot_data <- roh_cummulative %>% group_by(sample_id,Range) %>%
  summarise(Length = cumsum(Length)) %>% 
  group_by(Range) %>%
  summarise(median_length = median(Length))

plot_data %>%
  ggplot(aes(x=Range,y=median_length)) +
  geom_smooth() + 
  theme_classic()
