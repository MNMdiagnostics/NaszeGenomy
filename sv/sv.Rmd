...
sv.pers <- fread('../input/sv_multisample_210519.per_sample_stats.tsv', stringsAsFactors = T, na.strings = '.')
...
#            file = '../input/sv_multisample_210519.smoove.square.unrelated.af_stats_PASS.tsv')
